                ...
                <div className="grid gap-8 lg:grid-cols-2 lg:items-stretch">
                    ...
                    <div className="order-2 lg:order-1 rounded-2xl h-full">
                        <div className="grid grid-cols-2 gap-4 lg:grid-cols-1 h-full lg:grid-rows-3">
                            {/* Teléfono */}
                            <div
                                className="group relative overflow-hidden rounded-2xl border border-orange-100 bg-white p-6 shadow-sm lg:h-full transition-colors duration-200 hover:border-orange-200 hover:shadow-md"
                            >
                                ...
                                <p className="mt-1 text-base sm:text-lg text-gray-700">+54 11 1234-5678</p>
                            </div>
                            {/* Email */}
                            <div
                                className="group relative overflow-hidden rounded-2xl border border-orange-100 bg-white p-6 shadow-sm lg:h-full transition-colors duration-200 hover:border-orange-200 hover:shadow-md"
                            >
                                ...
                                <p className="mt-1 text-base sm:text-lg text-gray-700">info@tucatering.com</p>
                            </div>
                            {/* Ubicación */}
                            <div
                                className="group relative overflow-hidden rounded-2xl border border-orange-100 bg-white p-6 shadow-sm col-span-2 lg:col-span-1 lg:h-full transition-colors duration-200 hover:border-orange-200 hover:shadow-md"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6 text-orange-600">
                                ...
                                <p className="mt-1 text-base sm:text-lg text-gray-700">Buenos Aires, Argentina</p>
                            </div>
                        </div>
                    </div>
                    {/* Derecha (desktop) / Arriba (mobile): mismo formulario */}
                    <div
                        className="group relative overflow-hidden order-1 lg:order-2 rounded-2xl h-full border border-orange-100 bg-white p-8 shadow-sm transition-colors duration-200 hover:border-orange-200 hover:shadow-md focus-within:border-orange-200 focus-within:shadow-md"
                    >

        ...
        <section className={`space-y-6 ${className}`}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    ...
                    serán borrados de forma permanente. Antes de continuar,
                    descargá cualquier información que quieras conservar.
                </p>
            </header>
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        ...
                        borrados permanentemente. Ingresá tu contraseña para

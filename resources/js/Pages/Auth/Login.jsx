...
import { ArrowLeft, Eye, EyeOff, Utensils, Users, Award } from 'lucide-react';
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8 lg:hidden">
                        ...
                        <p className="text-gray-600 font-serif mt-2">Acceso al panel administrativo</p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm shadow-2xl border-0 rounded-2xl transform hover:shadow-3xl transition-all duration-500 hover:-translate-y-1">
                        <div className="p-8">
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="group">
                                    ...
                                    <div className="relative">
                                        <TextInput
                                            ...
                                            placeholder="admin@tucatering.com"
                                        />
                                ...
                                <div className="flex items-center justify-between">
                                    <label className="flex items-center group cursor-pointer">
                                        <Checkbox
                                            ...
                                            className="w-4 h-4 text-orange-500 bg-gray-50 border-2 border-gray-300 rounded focus:ring-orange-500 focus:ring-2 transition-all duration-300"
                                        />
                                        <span className="ml-3 text-sm text-gray-600 font-serif group-hover:text-gray-900 transition-colors duration-300">
                                            Recordar sesión
                                        </span>
                                    </label>
                                    {canResetPassword && (
                                        <Link
                                            ...
                                            className="text-sm text-orange-500 hover:text-orange-600 font-serif transition-all duration-300 hover:underline"
                                        >
                                ...
                                <Link
                                    href="/"
                                    className="inline-flex w-full items-center justify-center rounded-xl border border-orange-400 bg-white px-4 py-3 text-sm font-semibold text-orange-400 transition hover:-translate-y-0.5 hover:bg-orange-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-orange-400"
                                >
                                    Volver al sitio
                                </Link>
                            </form>
